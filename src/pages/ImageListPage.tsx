...
import { ArrowLeft, Grid, List, Search, SlidersHorizontal, Share2, Trash2 } from 'lucide-react';
...
export function ImageListPage() {
  ...
  const loadImages = async () => {
    try {
      ...
      setImages(contentItems.map(item => ({
        ...item,
    ...
    <div className="fixed inset-0 bg-gray-50 flex flex-col">
      ...
      {selectedImage && (
        <FullScreenViewer
          item={{
            ...selectedImage,
            imageUrl: selectedImage.content_url,
            author: {
              name: selectedImage.creator.username,
              avatar: selectedImage.creator.avatar_url
            }
          }}
