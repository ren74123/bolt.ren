/*
  # Fix Content Items Relationships

  1. Changes
    - Drop existing content_items table and related objects
    - Recreate content_items table with proper profile relationship
  ...
  2. Security
    ...
    - Ensure proper profile relationship checks
*/
