...
drop policy if exists "Users can create prompts" on generation_prompts;
drop policy if exists "Users can view their own prompts" on generation_prompts;
drop policy if exists "Users can update their own prompts" on generation_prompts;
drop policy if exists "Users can delete their own prompts" on generation_prompts;
drop policy if exists "Users can view their own results" on generation_results;
drop policy if exists "Users can create results for their prompts" on generation_results;
